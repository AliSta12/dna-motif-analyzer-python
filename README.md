...
- `figures/` – application screenshots and visualizations  
- `results/` – example exported analysis reports  
...
![Motif Selector](figures/motif_selector.png)

### Example results table

![Results Example](figures/results_example.png)

### Results visualization

![Results Visualization](figures/results_visualisation_example.png)
